...
public class LevelModeGUI extends JFrame {
    ...
    public LevelModeGUI() {
        ...
        timer = new Timer(1000, new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (remainingTime <= 0) {
                    ...
                    JOptionPane.showMessageDialog(LevelModeGUI.this, "Game Over!");
                }
            }
        });
        ...
        helpButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(LevelModeGUI.this, panel, "Game Introduction", JOptionPane.INFORMATION_MESSAGE);
            }
        });
    ...
    private void checkWinCondition() {
        if (remainingVertices == 0) {
            ...
            JOptionPane.showMessageDialog(this, "Congratulations! You passed Level" + level + "!");
            level += 1;
            if (level <= 4) {
                remainingTime = 300;
                mapObject = new Map();
                remainingVertices = mapObject.map.length * mapObject.map[0].length;
                mapObject.shuffle(50 * level);
                drawMap();
                setMouseListenersEnabled(true);
                timer.start();
            } else {
