...
public class CasualModeGUI extends JFrame {
    ...
    public CasualModeGUI() {
        ...
        timerLabel = new JLabel("Remaining Time: infinite"); // Initial label
        ...
        helpButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(CasualModeGUI.this, panel, "Game Introduction", JOptionPane.INFORMATION_MESSAGE);
            }
        });
